...
save_restoreSet_status_prefix("poka:")
dbLoadRecords("$(AUTOSAVE)/asApp/Db/save_restoreStatus.db", "P=poka:, DEAD_SECONDS=5")
...
set_pass0_restoreFile("auto_positions.sav", "P=poka:")
# Save positions every five seconds
doAfterIocInit("create_monitor_set('auto_positions.req',5,'P=poka:')")

set_pass0_restoreFile("auto_settings.sav", "P=poka:")
set_pass1_restoreFile("auto_settings.sav", "P=poka:")
# save settings every thirty seconds
doAfterIocInit("create_monitor_set('auto_settings.req',30,'P=poka:')")

# Note that you can reload these sets after creating them: e.g., 
# reload_monitor_set("auto_settings.req",30,"P=poka:")
...
#set_pass0_restoreFile("myGenericData.sav", "P=poka:")
#set_pass1_restoreFile("myGenericData.sav", "P=poka:")
...
set_requestfile_path("$(TOP)", "pokaApp/Db")
